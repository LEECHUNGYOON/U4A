        ...
        ([(function(module, exports, __webpack_require__) {
                ...
                _createClass(Selection, [{
                    ...
                    value: function normalizedToRange(range) {
                        ...
                        var indexes = positions.map(function(position) {
							...
							/* 20201224 soccerhs 
								- E-Mail 형식의 값을 입력 후, 자동으로 링크 생성 시,
								마우스로 드래그 하여 블록 잡을 때 "blot" Object가 없어서
								오류가 발생되는 문제 수정함.
							*/
							if(blot == null){
								return 0;
            ...
            var ScrollBlot = (function(_super) {
                ...
                ScrollBlot.prototype.optimize = function(mutations, context) {
                    ...
                    var mark = function(blot, markParent) {
						...
						/* 20201224 soccerhs
							- IE BUG
							- E-Mail 형식의 데이터를 입력 후 focusout 시
							Object가 없어서 오류 발생
							- 빈 Object를 넣어서 문제 수정함						
						*/
            ...
            var SnowTooltip = function(_BaseTooltip) {
                ...
                _createClass(SnowTooltip, [{
                    ...
                    value: function show() {
						/*	20201224 soccerhs
							- E-Mail 형식의 값을 입력 시, 자동으로 생성되는 링크 영역을 마우스로 클릭하면
							툴팁 형태의 팝업을 호출하는 기능을 제거 하기 위해 return 처리 함.
						*/
