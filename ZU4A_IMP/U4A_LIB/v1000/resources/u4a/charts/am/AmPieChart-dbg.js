...
"sap/ui/core/Control",
    ...
    var Sample = Control.extend("u4a.charts.am.AmPieChart", {
        metadata : {
            ...
            properties : {
				...
				innerRadius : { type: "int", defaultValue: null },
				labelRadius : { type: "int", defaultValue: null },
				outlineAlpha : { type: "float", defaultValue: null },
				outlineColor : { type: "sap.ui.core.CSSColor", defaultValue: null },
				outlineThickness : { type: "int", defaultValue: null },
				...
				radius : { type: "string", defaultValue: null },
				marginTop : { type: "int", defaultValue: 10 },
				marginLeft : { type: "int", defaultValue: null },
				marginRight : { type: "int", defaultValue: null },
				marginBottom : { type: "int", defaultValue: 10 },
				autoMargins : { type: "boolean", defaultValue: true },
				showRadiusText : { type: "boolean", defaultValue: true },
            ...
            events : {
				...
				clickSlice : {allowPreventDefault: true},
				pullInSlice : {allowPreventDefault: true},
				pullOutSlice : {allowPreventDefault: true},
				rollOverSlice : {allowPreventDefault: true},
            }
        }, // end of metadata
