sap.ui.define("u4a.charts.am5.MapPointSeries", [
    ...
    let _oMapPointSeries = MapSeries.extend("u4a.charts.am5.MapPointSeries", {
        metadata : {
            ...
            properties : {
                ...
                //국가(지역) 바인딩 필드.
                //GT_OTAB:[{F01:"KR-11"},..]와 같이 데이터를 구성했을때.
                //longitudeField에 GT_OTAB-F01 필드를 바인딩을 설정하여 포인터 출력을 위한
                //국가(지역) id 정보를 설정할 수 있다.
                //해당 속성은 위도(latitudeField), 경도(longitudeField)를 같이 설정 하더라도
                //polygonIdField값을 우선으로 판단한다.
                //(서울의 지역의 id - KR-11)
                polygonId : { type : "string", defaultValue: "" }
