sap.ui.define("u4a.charts.am5.Triangle", [
    ...
    let _oTriangle = BulletItem.extend("u4a.charts.am5.Triangle", {
        metadata : {
        ...
        _createSprite : function(){
            ...
            this._oChart.oChartInstance = am5.Triangle.new(_oParent?._oChart?.oRoot, _sChartProp);
