sap.ui.define("u4a.charts.am5.CategoryItem", [
    "sap/ui/core/Element",
    ...
    let _oCategoryItem = Element.extend("u4a.charts.am5.CategoryItem", {
        metadata : {
            library : "u4a.charts.am5",
            properties : {

                //카테고리에 출력할 값 정보.(categoryText)
            ...
            aggregations : {
                ...
                //막대(BAR) aggregation.
                barItems : { type : "u4a.charts.am5.BarItem", multiple : true, singularName: "barItem" },

                //꺾은선(LINE) aggregation.
                lineItems : { type : "u4a.charts.am5.LineItem", multiple : true, singularName: "lineItem" },
        ...
        _getChartData : function(){
            ...
            if(typeof _oGrid !== "undefined"){
                //category의 label 세팅 정보 매핑.
                _sChartData.grid = _oGrid._getChartData();
            }
