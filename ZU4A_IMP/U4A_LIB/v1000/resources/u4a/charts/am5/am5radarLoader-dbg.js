sap.ui.define("u4a.charts.am5.am5radarLoader", [
    "sap/base/util/uid"
],function(uid){

    //이미 am5radar 라이브러리가 로드 됐다면 exit.
    if(typeof window?.am5radar !== "undefined"){
        return;
    }

    let _url = sap.ui.require.toUrl("am5Chart") + "/radar.js";
