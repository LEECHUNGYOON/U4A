sap.ui.define("u4a.charts.am5.RadarValueAxis", [
    "u4a/charts/am5/Axis"
    ...
    let _oRadarValueAxis = Axis.extend("u4a.charts.am5.RadarValueAxis", {
        metadata : {
            ...
            properties : {
                ...
                //radarChart 전용 속성 정보.
                //y축의 시작 각도.
                //값을 변경 할 경우 radar의 시작 위치가 변경된다.
                axisAngle : { type : "int", defaultValue : -90 },
            ...
            aggregations : {
                ...
                //시계바늘 aggregation 정보.
                clockHands : { type : "u4a.charts.am5.ClockHand", multiple : true, singularName : "clockHand" }
        ...
        /*************************************************************
         * @function - y축의 Gauge 표현을 위한 바늘 정보 생성 처리.
         *************************************************************/
        _createClockHand : function(){

            let _aClockHands = this.getClockHands();

            if(_aClockHands.length === 0){
                return;
            }

            for (let i = 0, l = _aClockHands.length; i < l; i++) {
                
                let _oClockHands = _aClockHands[i];

                _oClockHands._createClockHand();
        ...
        setNumberFormat : function(propValue){
            ...
            let _propValue = this._setProperty("numberFormat", propValue);
        ...
        /*************************************************************
         * @function - axisAngle 프로퍼티 값 설정 function 재정의.
         *************************************************************/
        setAxisAngle : function(propValue){

            let _propValue = this._setProperty("axisAngle", propValue);


            //차트 Instance에 axisAngle settings 값 반영 처리.
            this._setChartRendererSetting("axisAngle", _propValue);
