sap.ui.define("u4a.charts.am5.BarItem", [
    "u4a/charts/am5/BaseColumnSeries"
], function(BaseColumnSeries){
    "use strict";

    
    let _oBarItem = BaseColumnSeries.extend("u4a.charts.am5.BarItem", {
        metadata : {
            library : "u4a.charts.am5",
            properties : {

                //막대의 좌측하단 모서리.(am5.RoundedRectangle)
                //값이 커질수록 모서리가 더욱 둥글게 변한다.
                cornerRadiusBL : { type : "int", defaultValue : 0 },


                //막대의 우측하단 모서리.(am5.RoundedRectangle)
                //값이 커질수록 모서리가 더욱 둥글게 변한다.
                cornerRadiusBR : { type : "int", defaultValue : 0 },


                //막대의 좌측상단 모서리.(am5.RoundedRectangle)
                //값이 커질수록 모서리가 더욱 둥글게 변한다.
                cornerRadiusTL : { type : "int", defaultValue : 0 },


                //막대의 우측상단 모서리.(am5.RoundedRectangle)
                //값이 커질수록 모서리가 더욱 둥글게 변한다.
                cornerRadiusTR : { type : "int", defaultValue : 0 }
        ...
        /*************************************************************
         * @function - cornerRadiusBL 프로퍼티 값 설정 function 재정의.
         *************************************************************/
        setCornerRadiusBL : function(propValue){

            this._setProperty("cornerRadiusBL", propValue);
        ...
        /*************************************************************
         * @function - cornerRadiusBR 프로퍼티 값 설정 function 재정의.
         *************************************************************/
        setCornerRadiusBR : function(propValue){

            this._setProperty("cornerRadiusBR", propValue);
        ...
        /*************************************************************
         * @function - cornerRadiusTL 프로퍼티 값 설정 function 재정의.
         *************************************************************/
        setCornerRadiusTL : function(propValue){

            this._setProperty("cornerRadiusTL", propValue);
        ...
        /*************************************************************
         * @function - cornerRadiusTR 프로퍼티 값 설정 function 재정의.
         *************************************************************/
        setCornerRadiusTR : function(propValue){

            this._setProperty("cornerRadiusTR", propValue);
