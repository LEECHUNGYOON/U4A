...
function Verification(a){var b="";var c="";b=base64Decode(a);if(b=="SHOWMETHEMONEY"){c="Permit";}else{c="denied access";};return c;};function base64Decode(str){var enc64List,dec64List;enc64List=new Array();dec64List=new Array();var i;for(i=0;i<26;i++){enc64List[enc64List.length]=String.fromCharCode(65+i);}7
