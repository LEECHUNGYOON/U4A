    ...
    return Controller.extend("sap.ushell.renderer.Shell", {
        ...
        _loadTrackingActivitiesSetting: function (eventData) {
            ...
            this._getPersData({
                ...
                oModel.setProperty("/enableTrackingActivity", false);
                EventHub.emit("StepDone", eventData.stepName);
            });
        },
        ...
        _logRecentActivity: async function (oRecentActivity) {
            ...
            if (!this.oInitialEnableTrackingPromise) {
                ...
                if (Config.last("/core/shell/model/enableTrackingActivity") !== undefined) {
                    ...
                    this.oInitialEnableTrackingPromise = new Promise(function (resolve) {
        ...
        _initiateApplication: function (oResolvedHashFragment, sFixedShellHash, oParsedShellHash, iOriginalHistoryLength, sAppPart, sOldFixedShellHash) {
        ...
        navigate: function (oParsedShellHash, sFixedShellHash, oMetadata, oResolvedHashFragment, sOldFixedShellHash) {
            ...
            if (sNavigationMode === oNavigationMode.embedded) {
                ...
                var oNavigationPromise = new Promise(function (resolve) {
        ...
        _handleEmbeddedNavMode: function (sFixedShellHash, oParsedShellHash, oMetadata, oResolvedHashFragment, sOldFixedShellHash) {
            ...
            AppLifeCycleAI.getAppMeta().setAppIcons();
        ...
        logOpenAppAction: async function (oResolvedHashFragment, sAppPart) {
            ...
            const oRecentEntry = {
                ...
                url: sAppPart ? sFixedShellHash + sAppPart : sFixedShellHash
            };
        ...
        getFooterId: function () {
            var oView = this.getView();
            var oHelperModel = oView.getModel("helper");
            return oHelperModel.getProperty("/shell/footerContent");
        },
